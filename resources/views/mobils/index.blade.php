            ...
            <div class="col-5">
                ...
                <form method="post" action="{{ route('mobils.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="merk" id="merk" class="form-control  @error('merk') is-invalid @enderror">
                            <option value="">--Pilih Merk Mobil--</option>
                            @foreach ($merk as $item)
                                <option value="{{ $item->id }}" {{ old('merk') == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama_merk }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" name="harga_per_hari" value="{{ old('harga_per_hari') }}"
                                class="form-control  @error('harga_per_hari') is-invalid @enderror" id="harga_per_hari"
                                placeholder="Harga per hari mobil">
                    ...
                    <!-- Preview Image -->
                    <div class="mb-3">
                        <img id="imagePreview" src="" alt="Preview Gambar" style="display: none; width: 50px;">
                    </div>
                    <div class="mb-3">
                        ...
                        @foreach ($mobil as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('mobils.show', $data->id) }}" class="btn btn-info">Detail</a>
