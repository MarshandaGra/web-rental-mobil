                ...
                <div class="row">
                    ...
                    <form method="GET" action="{{ route('pesanan.index') }}">
                        ...
                        <div class="col-7">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="addDataModal" tabindex="-1" aria-labelledby="addDataModalLabel" aria-hidden="true" data-bs-backdrop="static">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ route('pesanan.store') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="pemesan" id="pemesan" class="form-control @error('pemesan') is-invalid @enderror">
                                                        <option value="">--Nama Pemesan--</option>
                                                        @foreach ($pemesan as $item)
                                                            <option value="{{ $item->id }}" {{ old('pemesan') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->nama_pemesan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="mobil" id="mobil" class="form-control @error('mobil') is-invalid @enderror">
                                                        <option value="">--Nama mobil--</option>
                                                        @foreach ($mobil as $item)
                                                            <option value="{{ $item->id }}" {{ old('mobil') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->nama_m }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="bayar" id="bayar" class="form-control @error('bayar') is-invalid @enderror">
                                                        <option value="">--Jenis Bayar--</option>
                                                        @foreach ($bayar as $item)
                                                            <option value="{{ $item->id }}" {{ old('bayar') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->jenis_bayar }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <input type="date" name="tanggal_kembali" value="{{ old('tanggal_kembali') }}" class="form-control @error('tanggal_kembali') is-invalid @enderror" id="tanggal_kembali">
                        ...
                        <table class="table table-bordered ml-3 p-2">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Pemesan</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('pesanan.destroy', $data->id) }}" method="POST"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-danger pr-3"
